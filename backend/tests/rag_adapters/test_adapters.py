...
from tnpsc_book_rag.rag_adapters.embeddings import EMBEDDING_DIMENSION, EmbeddingBatch
from tnpsc_book_rag.rag_adapters.generation import PydanticAIGenerator, StructuredAnswer
...
class TestAnswerOrchestrator:
    ...
    async def test_full_pipeline_with_mocks(self) -> None:
        from tnpsc_book_rag.http_api.answer_service import AnswerOrchestrator, AnswerResult
